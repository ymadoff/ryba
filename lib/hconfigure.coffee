...
module.exports = (options) ->
  ...
  @call (_, callback) ->
    ...
    options.log? message: "Read default properties from #{options.default}", level: 'DEBUG', module: 'ryba/lib/hconfigure'
  ...
  @call ->
    ...
    options.log? message: "Merge default properties", level: 'DEBUG', module: 'ryba/lib/hconfigure'
