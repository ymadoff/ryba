...
correct for RHEL, it is installed in "/usr/lib/bigtop-utils" on my CentOS.
    ...
    module.exports.push name: 'Hadoop Core # Hadoop OPTS', timeout: -1, handler: (ctx, next) ->
      ...
      ctx.fs.exists '/usr/libexec/bigtop-utils', (err, exists) ->
        ...
        ,
          match: /^export HADOOP_HEAPSIZE="\$\{HADOOP_HEAPSIZE\} (.*)" # GENERATED BY RYBA, DONT OVEWRITE/mg
          replace: "export HADOOP_HEAPSIZE=\"#{hadoop_heap}\" # GENERATED BY RYBA, DONT OVEWRITE"
          append: /^export HADOOP_HEAPSIZE=".*"$/mg

        ,
          match: /^export HADOOP_NAMENODE_INIT_HEAPSIZE="\$\{HADOOP_NAMENODE_INIT_HEAPSIZE\} (.*)" # GENERATED BY RYBA, DONT OVEWRITE/mg
          replace: "export HADOOP_NAMENODE_INIT_HEAPSIZE=\"${HADOOP_NAMENODE_INIT_HEAPSIZE} #{hadoop_namenode_init_heap}\" # GENERATED BY RYBA, DONT OVEWRITE"
          append: /^export HADOOP_NAMENODE_INIT_HEAPSIZE=".*"$/mg
        ,
          match: /^export HADOOP_OPTS="\$\{HADOOP_OPTS\} (.*)" # GENERATED BY RYBA, DONT OVEWRITE/mg
          replace: "export HADOOP_OPTS=\"${HADOOP_OPTS} #{hadoop_opts}\" # GENERATED BY RYBA, DONT OVEWRITE"
          append: /^export HADOOP_OPTS=".*"$/mg
        ,
          match: /^export HADOOP_CLIENT_OPTS="\$\{HADOOP_CLIENT_OPTS\} (.*)" # GENERATED BY RYBA, DONT OVEWRITE/mg
          replace: "export HADOOP_CLIENT_OPTS=\"${HADOOP_CLIENT_OPTS} #{hadoop_client_opts}\" # GENERATED BY RYBA, DONT OVEWRITE"
          append: /^export HADOOP_CLIENT_OPTS=".*"$/mg
        ]
