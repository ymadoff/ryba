...
export CATALINA_PID="{{ryba.httpfs.pid_dir}}/httpfs.pid"
HTTPFS_HTTP_PORT="{{ryba.httpfs.http_port}}"
HTTPFS_ADMIN_PORT="{{ryba.httpfs.http_admin_port}}"
HTTPFS_HTTP_HOSTNAME="{{host}}"
HTTPFS_LOG="{{ryba.httpfs.log_dir}}"
HTTPFS_TEMP={{ryba.httpfs.tmp_dir}}
