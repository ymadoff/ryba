...
```
    ...
    module.exports.push skip: true, name: 'Nagios # Check Config', label_true: 'CHECKED', handler: (ctx, next) ->
      ctx.execute
    ...
    module.exports.push skip: true, name: 'Nagios # Check Command', label_true: 'CHECKED', handler: (ctx, next) ->
