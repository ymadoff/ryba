...
## Configuration Distributed mode
      ...
      for property in properties then hbase.rs.site[property] ?= hbase.site[property]
...
## Configuration HBase Replication
      ...
      hbase.rs.site['hbase.replication'] ?= m_ctxs[0].config.ryba.hbase.master.site['hbase.replication']
